...
// Set up CLI metadata
program.name("codey-eval").description("CLI tool for orchestrating Codey evaluations across multiple benchmarks").version("0.1.0")
...
program
	...
	.option("-k, --api-key <apiKey>", "Codey API key to use for evaluations")
	.action(async (options) => {
		try {
