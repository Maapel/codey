 ...
 * GitOperations Class
 *
 * Handles git-specific operations for Codey's Checkpoints system.
 *
...
export class GitOperations {
	...
	public async initShadowGit(gitPath: string, cwd: string, taskId: string): Promise<string> {
		...
		await git.addConfig("user.name", "Codey Checkpoint")
		await git.addConfig("user.email", "checkpoint@codey.bot")
